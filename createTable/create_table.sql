...
(
    ...
    thumbNum    int      default 0                 not null comment '题目点赞数',
    favourNum   int      default 0                 not null comment '题目点赞数',
...
(
    ...
    status     int      default 0                 not null comment '提交状态：0-等待判题，1-判题中，2-成功，3-失败',
    userId     bigint                             not null comment '创建用户id',
